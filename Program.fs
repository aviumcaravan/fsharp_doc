...
let main _ =
    ...
    //If your function is meant to return a value (an arithmetical operation, for example), this is the only case when an explicit value to be returned is required.
